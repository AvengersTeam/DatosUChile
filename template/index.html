...
<section id="explora">
  ...
  <div class="row adjust">
    ...
    <div id="busquedas" class="col-sm-6">
      ...
      <div class="col-sm-6">
        <div class="row">
          <div class="col-sm-12 noresize"><a href="#">#término1</a></div>
          <div class="col-sm-6 noresize"><a href="#">#término2</a></div>
          <div class="col-sm-6 noresize"><a href="#">#término3</a></div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="row">
          <div class="col-sm-6 noresize"><a href="#">#término4</a></div>
          <div class="col-sm-6 noresize"><a href="#">#término5</a></div>
          <div class="col-sm-12 noresize"><a href="#">#término6</a></div>
        </div>
      </div>
    </div>
  </div>
...
<section id="descubre">
  ...
  <p align="center">Visita, consulta y descubre todas las posibilidades que se pueden <br>lograr con los datos abiertos de la Universidad de Chile.</p>

  <div class="row adjust">
    <h3>Nuestros rectores y sus obras</h3>
    <div id="rectores-obras-texto" class="col-xs-3 bg-blanco">
      <p>Desde Andrés Bello a Ennio Vivaldi, 30 rectores han dejado su huella en las aulas de la Universidad de Chile en sus 172 años de historia. Revisa aquí las publicaciones de cada uno de ellos a lo largo de los años.</p>
    </div>
    <div id="timeline-wrap" class="col-xs-9 noresize">
      <div id="descubre-timeline" class="noresize"></div>
    </div>
  </div>
  <br/>
  <div class="row adjust">
    <div id="presidentes-de-chile" class="col-xs-7">
      <h3>Presidentes de Chile</h3>
      <div class="row">
        <div id="presidentes-de-chile-texto" class="col-xs-6 bg-blanco">
    ...
    <div id="efemerides" class="col-xs-5">  
      <h3>Efemérides</h3>
      <div class="row">
        <div class="col-xs-6 bg-blanco">
